...
> = {
    en: { flag: "🇬🇧", englishName: "English", nativeName: "English", coords: [51.5074, -2], countryCode: "gb" },
    ...
    sv: { flag: "🇸🇪", englishName: "Swedish", nativeName: "Svenska", coords: [62, 18.0686], countryCode: "se" },
    ...
    da: { flag: "🇩🇰", englishName: "Danish", nativeName: "Dansk", coords: [55.6761, 11], countryCode: "dk" },
    ...
    ang: { flag: "🏴", englishName: "Old English", nativeName: "Ænglisc", coords: [54, 0], countryCode: "gb" },
    ohg: { flag: "🏴", englishName: "Old High German", nativeName: "Althochdeutsch", coords: [50.1109, 8.6821], countryCode: "xx" },
    non: { flag: "🏴", englishName: "Old Norse", nativeName: "Norrœnt", coords: [65, 10.75], countryCode: "xx" },
